<section class="relative w-full bg-primary" aria-label="Expert Analysis">
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-14">
        ...
        <div class="max-w-3xl">
            ...
            <p class="mt-4 md:mt-5 text-sm sm:text-base leading-relaxed text-gray-400">
        ...
        <div class="mt-12 flex justify-center">
            <a href="#"
                class="inline-flex items-center justify-center rounded-full bg-[#2196F3] px-8 py-3 text-white font-semibold shadow-lg hover:bg-[#1976D2] hover:-translate-y-1 transition-all duration-300">
                View More Insights
            </a>
        </div>
    </div>
