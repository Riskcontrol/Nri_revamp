<x-layout title="Security Intelligence Hub">
    ...
    <section class="min-h-screen bg-[#f8fafc] font-sans antialiased">
        ...
        {{-- $featuredReport is passed from SecurityHubController::index() --}}
        {{-- ============================================================ --}}
        @if ($featuredReport)
            @php
                ...
                <div class="relative z-10 container mx-auto px-6 py-16">
                    <div class="max-w-3xl mx-auto space-y-6">
                        ...
                        <div class="pt-4 flex flex-wrap justify-start gap-6">
                            ...
                            {{-- Download Button — three states: guest / locked / allowed --}}
                            @guest
    ...
    {{-- ============================================================ --}}
    {{-- TIER LOCK MODAL (same component used on reports/risk-map)   --}}
    {{-- ============================================================ --}}
    <x-tier-lock-modal />
    ...
    <script>
        ...
        // ─── Tier Lock Modal (identical pattern to Risk Map / Reports pages) ──
        ...
        // Wire close buttons — same pattern as Risk Map
        ...
        // Server-side flash (direct URL bypass)
