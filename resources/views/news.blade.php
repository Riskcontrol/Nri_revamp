<x-layout title="Security Intelligence Hub">
    ...
    <section class="min-h-screen bg-[#f8fafc] font-sans antialiased">
        ...
        ══════════════════════════════════════════════════════════ --}}
        <div class="bg-white text-primary px-4 sm:px-6 py-10 sm:py-14 lg:px-16 shadow-inner">
            <div class="max-w-7xl mx-auto">
                <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 lg:gap-12">
                    <div class="lg:w-1/2 space-y-3">
                        <h1
                            class="text-2xl sm:text-3xl md:text-4xl font-medium tracking-tight leading-[1.1] text-primary">
                            Public Safety and Awareness Hub
                        </h1>
                        <p class="text-gray-500 text-base sm:text-lg leading-relaxed max-w-md font-medium">
                            Our platform leverages real-time data and interactive analytics to provide actionable
                            insights into public safety risks across Nigeria, empowering citizens, organizations, and
                            policymakers to make informed safer decisions.
                        </p>
                    </div>

                    <div class="w-full lg:w-5/12 bg-white rounded-2xl p-5 sm:p-8 border-2 border-primary shadow-md">
                        <div class="flex flex-col items-center justify-center mb-5 sm:mb-8">
                            <h2
                                class="text-xs sm:text-sm font-semibold text-primary uppercase tracking-widest text-center">
                                Real time Security Dashboard
                            </h2>
                        </div>
                        <div class="grid grid-cols-3 gap-3 sm:gap-6 text-center">
                            <div class="space-y-1">
                                <span class="block text-3xl sm:text-4xl font-semibold text-primary">
                                    {{ number_format($totalIncidents) }}
                                </span>
                                <span
                                    class="text-[9px] uppercase text-gray-500 font-semibold tracking-widest leading-tight block">
                                    Incidents this week
                                </span>
                            </div>
        ...
        ══════════════════════════════════════════════════════════ --}}
        @include('partials.news.risk-map-panel')
        {{-- ══════════════════════════════════════════════════════════
             INCIDENTS TABLE
        ══════════════════════════════════════════════════════════ --}}
        <div id="incidents-table" class="py-8 sm:py-10 px-4 sm:px-6 lg:px-16 bg-primary">
            <div class="max-w-7xl mx-auto">
                <div class="mb-5">
                    <h2 class="text-lg sm:text-xl font-semibold text-white mb-4">Recent Incidents</h2>
                    <form method="GET" action="{{ url()->current() }}" class="relative w-full sm:w-auto inline-block">
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                <i class="fa-solid fa-filter text-gray-400"></i>
                            </div>
                            <select name="region" onchange="this.form.submit()"
                                class="block w-full sm:w-auto p-3 pl-10 text-sm text-white border border-white/10 rounded-lg bg-[#162536] focus:ring-blue-500 focus:border-blue-500 placeholder-gray-400">
        ...
        @if ($featuredReport)
            ...
            <section class="relative w-full min-h-[200px] flex items-center bg-cover bg-center overflow-hidden"
                ...
                <div class="relative z-10 container mx-auto px-4 sm:px-6 py-10 sm:py-16">
        ...
        {{-- ══════════════════════════════════════════════════════════
             INSIGHTS SECTION
        ══════════════════════════════════════════════════════════ --}}
        <section class="bg-white py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-16">
            <div class="max-w-7xl mx-auto">
